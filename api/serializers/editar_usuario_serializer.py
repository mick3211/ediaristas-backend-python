...
class EditarUsuarioSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Usuario
        fields = ('nome_completo', 'cpf', 'nascimento', 'foto_usuario', 'telefone', 'password',
            'password_confirmation', 'new_password', 'chave_pix',)
    ...
    def validate_password(self, password):
        ...
        if not usuario.check_password(password):
            raise serializers.ValidationError('A senha atual é difrente da informada')
        return password
