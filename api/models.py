...
from .managers.diaria_manager import DiariaManager
...
class AvaliacaoDiaria(models.Model):
    ...
    diaria = models.ForeignKey(Diaria, null=False, blank=False, on_delete=models.CASCADE, related_name="avaliacao_diaria")
    avaliador = models.ForeignKey(Usuario, null=True, blank=False, on_delete=models.CASCADE, related_name="avaliador")
    avaliado = models.ForeignKey(Usuario, null=False, blank=False, on_delete=models.CASCADE, related_name="avaliado")

    objects = models.Manager()
    avaliacao_objects = AvaliacaoManager()